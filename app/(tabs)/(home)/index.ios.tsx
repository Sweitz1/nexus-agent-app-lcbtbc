...
export default function DashboardScreen() {
  ...
  const statCards = [
    { label: 'Active', value: activeTasks.length, Icon: Zap, color: COLORS.primary, bg: COLORS.primaryMuted },
    { label: 'Memory', value: memoryCount, Icon: Database, color: COLORS.info, bg: COLORS.infoMuted },
    { label: 'Providers', value: connectedProviders.length, Icon: Cpu, color: COLORS.warning, bg: 'rgba(255,184,0,0.12)' },
  ];
      ...
      >
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <AnimatedPressable onPress={() => { console.log('[Dashboard] View all tasks'); router.push('/(tabs)/tasks'); }}>
...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 13, color: COLORS.textSecondary, marginTop: 4, fontFamily: FONTS.mono },
  statusDot: {
    width: 10,
    height: 10,
    borderRadius: 5,
  ...
  ctaBtnText: { color: COLORS.background, fontSize: 16, fontWeight: '800' },
  ...
  statValue: { fontSize: 22, fontWeight: '800', color: COLORS.text, fontFamily: FONTS.mono },
  ...
  taskGoal: { fontSize: 14, color: COLORS.text, fontWeight: '500', marginBottom: 4 },
  ...
  quickLinksGrid: { flexDirection: 'row', gap: 12, marginTop: 12 },
  quickLinkCard: {
    flex: 1,
    backgroundColor: COLORS.surface,
    borderRadius: RADIUS.md,
  ...
  quickLinkLabel: { fontSize: 11, color: COLORS.textSecondary, fontWeight: '600', textAlign: 'center' },
});
